    ...
    if (currentStep === 3) {
      ...
      if (values.ageGroup && values.supportCategory) {
        try {
          ...
          const roomId = await createRoom(getAnonymousId(), values.supportCategory);

          toast({
            title: "Welcome to WhisperSpace",
            description: "Creating your support room...",
          });
          ...
          toast({
            title: "Error",
            description: "Failed to create support room. Please try again.",
            variant: "destructive",
          });
        }
      }
